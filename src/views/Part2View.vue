    ...
    <ZoneCard v-if="zone === 'saqueig'" id="zona-saqueig" title="Saqueig del Campament">
      <div class="summary-box">
        ...
        <ul>
          ...
          <li>Un <strong>idol d'obsidiana</strong> tallat d'una bonica i terrorifica <strong>Reina Fey</strong>. Posseeix una <strong>petita quantitat de poder magic</strong>, pero que es exactament es dificil de discernir amb qualsevol control. Es un vincle amb la <strong>Reina Mab</strong>, l'antiga mestressa dels goblins.</li>
          <li>Examinant els cossos dels goblins: un <span class="dc-check">DC 15 Medicina</span> revela alguna cosa enterrada sota la pell d'un dels canells, amb forma de <strong>manilla d'espines</strong>. Les punxes sobresurten ocasionalment de la pell i filtren una <strong>foscor fumosa</strong>. Despres que els goblins hagin estat morts durant <strong>cinc minuts</strong>, aquestes manilles es <strong>dissiparan completament en fum</strong>.</li>
          <li>Les cabanes contenen roba humana, pertinences i menjar de les granges properes.</li>
        </ul>
      </div>

      <DmNote>
        <p><strong>Si un dels aventurers busca la seva mare:</strong> no hi ha cap rastre d'ella al campament. Nomes roba i pertinences d'altres vilatans. Les petjades i rastres de sang indiquen que algunes persones van ser portades <strong>cap a la cova</strong> per alimentar-les als basiliscs. La mare va ser una d'elles, pero <strong>no hi ha cap cos seu</strong> al cau &mdash; potser va aconseguir escapar.</p>
      </DmNote>
    </ZoneCard>

    <!-- Zona 2: La Boca de la Cova -->
    <ZoneCard v-if="zone === 'boca'" id="zona-boca" title="La Boca de la Cova">
      <p>El <strong>tunel de la cova s'esten mes endins</strong> del que investigacions previes haurien revelat. La boca de la cova aspira l'aire cap endins en lloc d'expulsar-lo. Una inquietud creixent s'apodera de qui s'hi acosta. El terra esta tacat d'un <strong>carmesi fosc</strong>, evidencia d'anys de pas.</p>

      <DmNote>
        <p>Entrar-hi amb llum revela un <strong>antic corredor treballat</strong> tallat a la muntanya, picat i marcat per l'edat. La maconeria original amb prou feines es <strong>reconeixible i impossible d'identificar</strong>. El rastre carmesi porta cap avall.</p>
        <p>Un control d'<span class="dc-check">Investigacio</span> mostra moviments d'una <strong>criatura mes gran</strong> a traves del passadis, tot i que si son recents o no es impossible de discernir.</p>
      </DmNote>
    ...
    <ZoneCard v-if="zone === 'mur'" id="zona-mur" title="El Mur de Sang">
      ...
      <DmNote>
        ...
        <ul>
          ...
          <li>Produira un <strong>clon exacte</strong> de qui o qualsevol cosa sigui el propietari de la sang com a agent hostil que atacara immediatament el grup.</li>
          <li><strong>Si els aventurers usen la seva propia sang:</strong> apareix un clon amb exactament les mateixes forces, habilitats i encanteris.</li>
          <li><strong>Si usen sang d'un goblin de gel mort:</strong> es reprodueix un unic goblin de gel.</li>
          <li><strong>Si llancen una criatura contra el mur:</strong> el nombre de gotes de sang que toquen el mur determina quantes criatures apareixeran (a discrecio del DM).</li>
        </ul>
      </DmNote>

      <ReadAloud>
        <p>Quan la sang toca el mur, se sent un gemec i totes les taques fosques del terra i les parets comencen a moure's, lliscant per sobre i a traves de les pedres com si el terra fos transparent, fins que s'acumulen al centre del mur i un clon de sang apareix. Les taques convergeixen com si tinguessin voluntat propia, pujant per les parets i arremolinant-se al voltant del punt de contacte.</p>
      </ReadAloud>

      <h3>Despres del Mur</h3>
      <p>Quan el clon (o l'ultim clon) mor, <strong>explota en sang</strong> causant <strong>ceguesa temporal</strong> als aventurers propers. La sang flueix de nou cap al mur i la paret retrocedeix dins la cova.</p>
